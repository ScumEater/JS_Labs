...
FPS.prototype = {
    ...
    init: function(container) {
        ...
        this._element = this._createElement("div","position:fixed;top:0;left:1838px;z-index:9999;background-color:#eee;display:inline;margin:1px;padding:4px;border:1px solid #888;font-family:Ubuntu,sans-serif;font-size:25px;color:black", container || document.body);
    },
